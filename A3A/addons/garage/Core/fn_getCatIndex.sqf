...
switch (true) do {
    ...
    case (_editorCat in ["EdSubcat_Planes"] && (getNumber (configOf _vehicle >> "vtol") == 0)): { 6 };
    case (_editorCat isEqualTo "EdSubcat_Boats") || (_editorCat isEqualTo "EdSubcat_Submersibles"): { 7 };
