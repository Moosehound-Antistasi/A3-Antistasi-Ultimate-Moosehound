...
private _text = switch _index do {
    ...
    case 4: {localize "STR_HR_GRG_Generic_AA"};
    case 5: {localize "STR_HR_GRG_Generic_Arty"};
    case 6: {localize "STR_HR_GRG_Generic_Heli"};
    case 7: {localize "STR_HR_GRG_Generic_Plane"};
    case 8: {localize "STR_HR_GRG_Generic_Boat"};
    case 9: {localize "STR_HR_GRG_Generic_Source"};
    case 10: {localize "STR_HR_GRG_Generic_Static"};
    default {""};
};
